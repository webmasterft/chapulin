<?php 
    $nombreEspecial="chapulinColorado";
    $libsRoot = "../../../libs/";
?>
<!DOCTYPE html>
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Chapulín Colorado :: EL COMERCIO</title>
        <meta name="description" content="">
        <meta name="viewport" content="width=device-width">
        <meta charset="UTF-8"> 
        <meta name="Origen" content="Chapulín Colorado - EL COMERCIO" />
        <meta name="Author" content="GRUPO EL COMERCIO :: Diseño Web" />
        <meta property="og:image" content="img/thumb-face.png" />
        <meta name="Lang" content="es" />
        <meta name="revisit-after" content="1 days" />
        <meta name="robots" content="INDEX,FOLLOW,NOODP" />
        <meta property="og:url" content="">
        <meta property="og:title" content="Chapulín Colorado - EL COMERCIO">
        <meta property="og:site_name" content="Chapulín Colorado - EL COMERCIO">
        <meta property="og:description" content="Chapulín Colorado - EL COMERCIO  :: Diseño Web">
    ...
    <body>
    <?php include($libsRoot.'comScore.php'); ?>
        <!--[if lt IE 9]>
...
<!--</div><!-- pt-page-1 -->
            ...
            <div class="pt-page pt-page-2"> 
                <div class=" container">
                    <div id="chapulin">                
                        <img id="idTxt" src="img/ch.png" width="363" height="192">
                    </div>    

                    <div id="personaje">                
                        <img id="idTxt" src="img/personaje.png" width="268" height="87">
                        <img id="idGraph" src="img/personaje2.png" width="524" height="482">
                    </div>    

                    <div id="armas">                
                        <img id="idTxt" src="img/armas.png" width="265" height="87">
                        <img id="idGraph" src="img/armas2.png" width="524" height="482">
                    </div>   
                    ...
                    <div id="villanos">                
                        <img id="idTxt" src="img/villanos.png" width="265" height="87">
                        <img id="idGraph" src="img/villanos2.png" width="524" height="482">
                    </div>   

                    <div id="psicologia">                
                        <img id="idTxt" src="img/psicologia.png" width="265" height="87">
                        <img id="idGraph" src="img/psicologia2.png" width="524" height="482">
                    </div>   
